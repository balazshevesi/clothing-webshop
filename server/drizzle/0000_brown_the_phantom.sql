...
--> statement-breakpoint
CREATE TABLE `article_planned_sales_relations` (
	`id` int AUTO_INCREMENT NOT NULL,
	`article_id` int NOT NULL,
	`planned_sale_id` int NOT NULL,
	CONSTRAINT `article_planned_sales_relations_id` PRIMARY KEY(`id`),
...
ALTER TABLE `article_planned_sales_relations` ADD CONSTRAINT `article_planned_sales_relation_articles_FK` FOREIGN KEY (`article_id`) REFERENCES `articles`(`id`) ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE `article_planned_sales_relations` ADD CONSTRAINT `article_planned_sales_relation_planned_sales_FK` FOREIGN KEY (`planned_sale_id`) REFERENCES `planned_sales`(`id`) ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE `article_properties` ADD CONSTRAINT `article_properties_articles_FK` FOREIGN KEY (`article_id`) REFERENCES `articles`(`id`) ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
