...
export default function Header() {
  return (
    <div className=" relative flex h-[90vh] items-center justify-center">
      <Image
        alt=""
        className=" relative z-0 h-full select-none overflow-hidden rounded-b-xl object-cover"
        height={2000}
        width={4000}
      ...
      <div className="absolute z-10 flex w-full flex-col items-center">
        <div className=" mx-auto w-1/2 text-balance text-center text-white">
          <Title1 className="font-bold drop-shadow-sm">
