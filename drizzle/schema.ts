...
export const articleImages = mysqlTable(
  "article_images",
  {
...
export const articleListingRelations = mysqlTable(
  ...
  (table) => {
    return {
      articleListingRelationsId: primaryKey({
        columns: [table.id],
        name: "article_listing_relations_id",
      }),
      articleListingRelationsUn: unique("article_listing_relations_UN").on(
        table.articleId,
        table.listingId,
      ),
    };
...
export const articlePlannedSalesRelation = mysqlTable(
  "article_planned_sales_relation",
  {
    id: int("id").autoincrement().notNull(),
    articleId: int("article_id").notNull(),
    plannedSaleId: int("planned_sale_id")
      .notNull()
      .references(() => articles.id, {
        onDelete: "cascade",
        onUpdate: "cascade",
  ...
  (table) => {
    return {
      articlePlannedSalesRelationId: primaryKey({
        columns: [table.id],
        name: "article_planned_sales_relation_id",
      }),
      articlePlannedSalesRelationUn: unique(
        "article_planned_sales_relation_UN",
      ).on(table.articleId, table.plannedSaleId),
    };
  },
);

export const articleProperties = mysqlTable(
  "article_properties",
  {
    id: int("id").autoincrement().notNull(),
  ...
  (table) => {
    return {
      articlePropertiesId: primaryKey({
        columns: [table.id],
...
export const articles = mysqlTable(
  "articles",
  {
    ...
    propertiesId: int("properties_id").references(() => articleProperties.id, {
      onDelete: "set null",
      onUpdate: "cascade",
    }),
...
export const carts = mysqlTable(
  "carts",
  {
    ...
    guestUserId: int("guest_user_id").references(() => guestUsers.id, {
      onDelete: "set null",
      onUpdate: "cascade",
    }),
  },
...
export const guestUsers = mysqlTable(
  "guest_users",
  {
    id: int("id").autoincrement().notNull(),
...
export const listings = mysqlTable(
  "listings",
  {
    ...
    description: text("description").notNull(),
    articleIdDefault: int("article_id_default").references(() => articles.id, {
      onDelete: "set null",
      onUpdate: "cascade",
    }),
...
export const plannedSales = mysqlTable(
  "planned_sales",
  {
    id: int("id").autoincrement().notNull(),
